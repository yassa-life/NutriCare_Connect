...
class PatientGuideServiceTest {
  private final PatientGuideService service =
      new PatientGuideService(RestClient.builder(), "", "gemini-3.5-flash-lite");
  ...
  void urgentQuestionNeverReceivesMedicalAdvice() {
    var response =
        service.answer("I have chest pain and this is an emergency", java.util.List.of());
