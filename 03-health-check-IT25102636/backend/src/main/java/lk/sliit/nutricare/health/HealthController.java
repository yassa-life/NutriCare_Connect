...
public class HealthController {
  ...
  @PreAuthorize(
      "hasAnyRole('DIETITIAN','DOCTOR','MEDICAL_CENTER_COORDINATOR') or (hasRole('PATIENT') and"
  ...
  record CheckRequest(
      ...
      @Positive Integer systolic,
      @Positive Integer diastolic,
      @Positive BigDecimal bloodSugar,
