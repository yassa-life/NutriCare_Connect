...
1. **Phase 1: Full Project Setup & Test Run**: How to download the complete working repository from GitHub, set up dependencies (Java 21, Node.js, local MySQL), run the system, and verify Module 06 (Feedback & Analytics).
